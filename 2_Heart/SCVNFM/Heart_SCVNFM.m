...
clc;
ExampleNum = 10; % 实验次数
MeanResults = zeros(ExampleNum,4);
...
TrainNum = round(0.7*DataNum);                     %   训练样本选70%
...
MeanResults(gogo,:) = [Best_TrainAcc,Best_TestAcc,Best_Epoch,t];

end

MeanAcc = sum(MeanResults,1)/ExampleNum;
