...
while(epochs<=MaxEpochs&l==0)
   ...
   for i=1:SampleNum
     ...
     NetworkOut(find(NetworkOut>=1.5))=2;
...
TenAcc(gogo,:) = [Best_TrainAcc,Best_TestAcc,Best_Epoch,t];
...
sprintf('平均训练时间=%0.2f',MeanAcc(1,4))
